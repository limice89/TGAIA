...
/** 默认的列数*/
static const NSInteger MKLDefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger MKLDefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger MKLDefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat MKLDefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets MKLDefaultEdgeInset = {10, 10, 10, 10};
@interface MKLFlowLayout()
/** 存放所有cell的布局属性*/
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == MKLWaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == MKLWaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == MKLWaterFlowVerticalEqualHeight || self.flowLayoutStyle == MKLLineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == MKLWaterFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == MKLWaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == MKLLineWaterFlow){
...
/*
 ...
 {
 if (self.flowLayoutStyle == MKLLineWaterFlow) {
