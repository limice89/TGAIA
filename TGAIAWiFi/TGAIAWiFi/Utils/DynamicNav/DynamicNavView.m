...
- (void)configSubviews
{
    ...
    self.navViewTotalHeight = kStatusBarHeight + nav_normal_height + nav_expand_height;//(导航条 44 底部导航拓展部分 52)
...
//        [_navView.backButton setTitle:@"返回" forState:UIControlStateNormal];
        [_navView.backButton setImage:IMAGE_NAMED(@"back_icon") forState:UIControlStateNormal];
