...
//    _backgroundView.backgroundColor = STModalRGBA(120, 125, 130, 1);
    _backgroundView.backgroundColor = KWhiteColor;
...
- (void)loadMessage{
    ...
    if (!_messageLabel){
        ...
        _messageLabel.textColor = kColor333;
...
- (UIButton *)addButton:(CGRect)frame title:(NSString *)title tag:(NSInteger)tag{
    ...
    [button setBackgroundImage:st_imageWithColor(STModalRGBA(235, 240, 240, 0.65)) forState:UIControlStateNormal];
